...
//
// INPUTS  : - tlv : &mut Tlv493d (struct containing parameters to use the sensor)
...
//
pub fn get_b_mean<I2c, E> (tlv : &mut Tlv493d<I2c, E>, n : u16, delay : &mut rppal::hal::Delay) -> Result<Bfield, Error<E>> 
where 
    I2c: i2c::Read<Error = E> + i2c::Write<Error = E> + i2c::WriteRead<Error = E>,
    E: core::fmt::Debug,
{
